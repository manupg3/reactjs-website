...
const HomeSection1 = () => {
  ...
  return (
    <div>
    <div class="h-[32rem] pt-14 relative overflow-hidden bg-no-repeat bg-cover bg-center back-linear " 
        >
            <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed" >
              <div class="flex justify-center items-center h-full">
                <div class="text-center text-white px-6 md:px-12">
                  <h1 class="pt-14 text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">The best offer on the market <br /><span>for your business</span></h1>
