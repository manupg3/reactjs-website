...
<section class="mb-32 text-gray-800">
  <div class="contact-frm-custom1 relative overflow-hidden bg-no-repeat bg-cover"
    >
  </div>
  <div class="container text-gray-800 px-4 md:px-12">
    <div class="contact-frm-custom2 block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6"
      >
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
        ...
        <div class="mb-12 lg:mb-0 text-center mx-auto">
          ...
          <h6 class="font-medium">Buenos Aires</h6>
        </div>
        ...
        <div class="text-center mx-auto">
          ...
          <h6 class="font-medium">Email: mail@mail.com</h6>
        </div>
      </div>
