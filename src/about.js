...
<section className="mb-32">
  ...
  <div className="flex flex-wrap">
    ...
    <div className="grow-0 shrink-0 basis-auto w-full lg:w-7/12">
      <div
        className="bg-white h-full rounded-lg p-6 lg:pl-12 text-gray-800 shadow-lg flex items-center text-center lg:text-left">
