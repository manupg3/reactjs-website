...
<div class="container my-24 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-900">
    <h2 class="text-3xl font-extrabold text-center mb-6">Pricing</h2>

    <p class="text-center mb-12 text-gray-500">
      ...
      <div class="mb-6 lg:mb-0">
        <div class="block rounded-lg shadow-lg bg-white h-full">
          <div class="p-6 border-b border-gray-300 text-center">
            ...
            <button type="button"
              class="inline-block px-6 py-2.5 bg-transparent bg-indigo-500 text-blue-600 font-medium text-xs leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out w-full"
      ...
      <div class="mb-6 lg:mb-0">
        <div class="block rounded-lg shadow-lg bg-white h-full">
          <div class="p-6 border-b border-gray-300 text-center">
            ...
            <h3 class="text-2xl mb-6">
              <strong>$ 129</strong>
              <small class="text-gray-500 text-sm">/año</small>
            </h3>
