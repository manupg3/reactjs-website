                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'text-black hover:text-gray-600' : 'hover:text-gray-600 text-black ',
                    ...
                    <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700 underline')}
                          >
                            Settings
                          </a>
                        )}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-gray-900 text-black underline decoration-black' : 'text-black hover:bg-indigo-600 hover:text-white',
